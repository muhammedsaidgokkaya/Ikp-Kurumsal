...
namespace EntityLayer.Concrete
{
    public class Context : IdentityDbContext<AppUser,AppRole,int>
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseMySQL(@"uid=ikpcom_ikpuser;pwd=Tk3VbeuTskUl;Host=88.99.185.109;Database=ikpcom_ikp;charset=utf8;");
            //@"uid = ikpcom_ikpuser; pwd = Tk3VbeuTskUl; Host = 88.99.185.109; Database = ikpcom_ikp; "
        }
